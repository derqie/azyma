...
public class CategoryDetails extends AppCompatActivity implements RecyclerView.OnScrollChangeListener {
    ...
    private JsonArrayRequest getDataFromServer(int requestCount) {
        ...
        JsonArrayRequest jsonArrayRequest = new JsonArrayRequest(ApiConfig.CATEGORIES_OFFER_URL +
