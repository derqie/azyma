...
import co.ke.daletsys.azyma.easychat.adapter.ChatRecyclerAdapter;
import co.ke.daletsys.azyma.easychat.model.ChatMessageModel;
...
public class ChatActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sUpdated = findViewById(R.id.sUpdated);
        ...
        if (otherUser.getStatus().equals("Online")) {
            ...
            sUpdated.setTextColor(getResources().getColor(R.color.lime));
        } else if (otherUser.getStatus().equals("Offline")) {
            status.setTextColor(getResources().getColor(R.color.cancel));
            sUpdated.setTextColor(getResources().getColor(R.color.cancel));
        }
